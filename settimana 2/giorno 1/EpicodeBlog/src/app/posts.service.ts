...
import { iPost } from '../app/Models/iPosts'; // Assicurati di importare correttamente il modello iPost
...
export class PostService {
  ...
  getPosts(active?: boolean): iPost[] {
    if (active !== undefined) {
      return this.posts.filter((post: iPost) => post.active === active);
    } else {
      return this.posts;
    }
  }
